...
contract ManualVerificationRegistry {
    ...
    event VerificationRequested(uint256 indexed requestId, bytes32 indexed credentialId, address indexed candidate, uint256 timestamp);
    event VerificationApproved(uint256 indexed requestId, bytes32 indexed credentialId, address indexed verifier, string note, uint256 timestamp);
    event VerificationRejected(uint256 indexed requestId, bytes32 indexed credentialId, address indexed verifier, string reason, uint256 timestamp);
    ...
    function getTeamVerification(bytes32 _credentialId) external view returns (TeamVerification memory) {
