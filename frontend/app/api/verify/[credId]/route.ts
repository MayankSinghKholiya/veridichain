...
const QIE_CHAIN_ID   = Number(process.env.NEXT_PUBLIC_QIE_CHAIN_ID   ?? "1983");
const QIE_CHAIN_NAME = process.env.NEXT_PUBLIC_QIE_CHAIN_NAME         ?? "QIE Testnet";
const QIE_RPC        = process.env.NEXT_PUBLIC_QIE_RPC_URL             ?? "https://rpc1testnet.qie.digital/";
const QIE_EXPLORER   = process.env.NEXT_PUBLIC_QIE_EXPLORER_URL        ?? "https://testnet.qie.digital";
